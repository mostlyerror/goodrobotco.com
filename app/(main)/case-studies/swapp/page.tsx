  ...
  return (
    <>
      ...
      <section className="py-24 md:py-32 bg-cream">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <Reveal>
            ...
            <h2 className="text-3xl font-display font-bold text-charcoal mb-6">The Pivot</h2>
            <p className="text-lg text-charcoal/80 leading-relaxed mb-4">
          ...
          <Reveal delay={0.1}>
            <div className="bg-white/60 border-l-4 border-coral p-6 rounded-r-lg">
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          ...
          <Reveal delay={0.1}>
            <div className="bg-gradient-to-br from-sage/20 to-sky/15 p-8 rounded-lg mb-6">
              <h3 className="text-2xl font-display font-bold text-charcoal mb-4">Key Features</h3>
      ...
      <section className="py-24 md:py-32 bg-cream">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <Reveal>
            ...
            <h2 className="text-3xl font-display font-bold text-charcoal mb-6">The Impact</h2>
          </Reveal>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <Reveal>
            <div className="grid md:grid-cols-[1fr,1.5fr] gap-6 items-center">
              <div>
                <div className="bg-cream border-l-4 border-sage p-6 rounded-r-lg shadow-sm">
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          ...
          <Reveal delay={0.1}>
            <div className="bg-white/60 border-l-4 border-coral p-6 rounded-r-lg space-y-4">
              <div>
                <h3 className="font-display font-bold text-charcoal mb-2">Rapid Prototyping</h3>
                <p className="text-charcoal/80">
              ...
              <div>
                <h3 className="font-display font-bold text-charcoal mb-2">Field-Ready Design</h3>
                <p className="text-charcoal/80">
              ...
              <div>
                <h3 className="font-display font-bold text-charcoal mb-2">Integration Architecture</h3>
                <p className="text-charcoal/80">
          ...
          <Reveal delay={0.2}>
            <div className="mt-6 grid md:grid-cols-2 gap-4 text-sm text-charcoal/80">
              <div>
                <h4 className="font-display font-bold text-charcoal mb-2">Tech Stack</h4>
              ...
              <div>
                <h4 className="font-display font-bold text-charcoal mb-2">Integrations</h4>
                <ul className="space-y-1">
                  <li>• Twilio (SMS)</li>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <Reveal>
            ...
            <h2 className="text-3xl font-display font-bold text-charcoal mb-6">What This Demonstrates</h2>
          </Reveal>
