      ...
      <section className="py-24 md:py-32 bg-cream">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <Reveal>
            ...
            <h2 className="text-3xl font-display font-bold text-charcoal mb-6">What We Did</h2>
          ...
          <div className="space-y-8">
            <Reveal delay={0.1}>
              <div>
                <h3 className="text-xl font-display font-bold text-charcoal mb-3">Phase 1: Immediate Relief</h3>
            ...
            <Reveal delay={0.2}>
              <div>
                <h3 className="text-xl font-display font-bold text-charcoal mb-3">Phase 2: Vendor Evaluation</h3>
                ...
                <div className="bg-white/60 border-l-4 border-coral p-6 rounded-r-lg">
                  <h4 className="font-display font-bold text-charcoal mb-2">Key Decision Factors</h4>
            ...
            <Reveal delay={0.3}>
              <div>
                <h3 className="text-xl font-display font-bold text-charcoal mb-3">Phase 3: Implementation Support</h3>
                <p className="text-charcoal/80 leading-relaxed mb-3">
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <Reveal>
            ...
            <h2 className="text-3xl font-display font-bold text-charcoal mb-6">The Result</h2>
          </Reveal>

          <Reveal delay={0.1}>
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-cream p-6 rounded-lg border border-charcoal/10">
