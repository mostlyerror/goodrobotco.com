      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <Reveal>
            ...
            <h2 className="text-3xl font-display font-bold text-charcoal mb-6">The Challenge</h2>
      ...
      <section className="py-24 md:py-32 bg-cream">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <Reveal>
            ...
            <h2 className="text-3xl font-display font-bold text-charcoal mb-6">What We Built</h2>
          ...
          <Reveal delay={0.1}>
            <div className="bg-gradient-to-br from-sage/20 to-sky/15 p-8 rounded-lg">
              <h3 className="text-2xl font-display font-bold text-charcoal mb-4">What It Does</h3>
      ...
      <section className="py-24 md:py-32 bg-cream">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <Reveal>
            ...
            <h2 className="text-3xl font-display font-bold text-charcoal mb-6">How It Works</h2>
            <p className="text-lg text-charcoal/80 leading-relaxed mb-6">
          ...
          <Reveal delay={0.1}>
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white p-6 rounded-lg border border-charcoal/10 hover:border-coral/30 transition-colors">
                <h3 className="text-xl font-display font-bold text-coral mb-2">Fix Leads</h3>
              ...
              <div className="bg-white p-6 rounded-lg border border-charcoal/10 hover:border-sage/30 transition-colors">
                <h3 className="text-xl font-display font-bold text-sage mb-2">Build Leads</h3>
                <p className="text-charcoal/70 mb-3">
              ...
              <div className="bg-white p-6 rounded-lg border border-charcoal/10 hover:border-sky/30 transition-colors">
                <h3 className="text-xl font-display font-bold text-sky mb-2">Social Only</h3>
                <p className="text-charcoal/70 mb-3">
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <Reveal>
            ...
            <h2 className="text-3xl font-display font-bold text-charcoal mb-6">The Engineering</h2>
            <p className="text-lg text-charcoal/80 leading-relaxed mb-6">
          ...
          <Reveal delay={0.1}>
            <div className="bg-cream/50 border-l-4 border-coral p-6 rounded-r-lg space-y-4">
              <div>
                <h3 className="font-display font-bold text-charcoal mb-2">Smart Retry Logic</h3>
              ...
              <div>
                <h3 className="font-display font-bold text-charcoal mb-2">Adaptive Scheduling</h3>
                <p className="text-charcoal/80">
              ...
              <div>
                <h3 className="font-display font-bold text-charcoal mb-2">Platform-Specific Detection</h3>
                <p className="text-charcoal/80">
      ...
      <section className="py-24 md:py-32 bg-cream">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <Reveal>
            ...
            <h2 className="text-3xl font-display font-bold text-charcoal mb-6">The AI Component</h2>
            <p className="text-lg text-charcoal/80 leading-relaxed mb-6">
          ...
          <Reveal delay={0.1}>
            <div className="bg-white/60 border-l-4 border-coral p-6 rounded-r-lg space-y-4">
              <div>
                <h3 className="font-display font-bold text-charcoal mb-2">Intelligent Web Scraping</h3>
                <p className="text-charcoal/80">
              ...
              <div>
                <h3 className="font-display font-bold text-charcoal mb-2">Smart Lead Classification</h3>
                <p className="text-charcoal/80">
              ...
              <div>
                <h3 className="font-display font-bold text-charcoal mb-2">Automated Research & Enrichment</h3>
                <p className="text-charcoal/80">
      ...
      <section className="py-24 md:py-32 bg-charcoal">
        <div className="max-w-4xl mx-auto px-6 md:px-12">
          <Reveal>
            ...
            <h2 className="text-3xl font-display font-bold text-cream mb-6">The Result</h2>
          ...
          <Reveal delay={0.1}>
            <div className="bg-cream/10 p-6 rounded-lg">
              <p className="text-lg text-cream/90 font-semibold mb-2">
